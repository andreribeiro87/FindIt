  ...
  return (
    <div>
      ...
      >
        ...
        <Marker
          position={[40.62346750937607, -8.650157603650532]}
        ...
        >
          <Popup>
            <div>
              ...
              <p>
                <strong>Distance:</strong> 1.6 km
              </p>
              <p>
                <strong>Accessibility:</strong> No
              </p>
              <button
                className={styles.dirbutton}
                onClick={() => console.log("Direções")}
              >
                Get directions
              </button>
              <button
                ...
                onClick={() => {
                  allMarkets.map((market) => {
                    console.log(market, "DADY");
                    if (market.id == "1") {
                      setiWantSeeWhat("produtos");
                      return setChosenSuperMarket([market]);
                    }
                  });
                }}
              >
        ...
        <Marker
          position={[40.64221769744397, -8.637837045230306]}
          icon={supermarketicon}
        >
          <Popup>
            <div>
        ...
        <Marker
          position={[40.626945128935944, -8.64407200875597]}
          icon={supermarketicon}
        >
          <Popup>
            <div>
